...
# template_gray_file_original='/storage1/fs1/dharr/Active/ATUL/PROJECTS/DeepReg/DATA/TEMPLATES/scct_strippedResampled1.nii.gz'
# I=nib.load(template_gray_file_original) 
# I_data=I.get_fdata()
# print('min::{}::max::{}'.format(np.min(I_data),np.max(I_data)))
# gray2binary(filename_template)
template_gray_file_transformed='/storage1/fs1/dharr/Active/ATUL/PROJECTS/DeepReg/DATA/SAH_1_01052014_2003_2/SAH_1_01052014_2003_2_resaved_levelset_brain_fscct_strippedResampled1lin1_1.nii.gz'
template_gray_file_transformed_mask='/storage1/fs1/dharr/Active/ATUL/PROJECTS/DeepReg/DATA/SAH_1_01052014_2003_2/SAH_1_01052014_2003_2_resaved_levelset_brain_fscct_strippedResampled1lin1_1_BET.nii.gz'

grayfilename='/storage1/fs1/dharr/Active/ATUL/PROJECTS/DeepReg/DATA/SAH_1_01052014_2003_2/SAH_1_01052014_2003_2_resaved_levelset_brain_f.nii.gz'
grayfilename_mask='/storage1/fs1/dharr/Active/ATUL/PROJECTS/DeepReg/DATA/SAH_1_01052014_2003_2/SAH_1_01052014_2003_2_resaved_levelset_brain_f_BET.nii.gz'

h5data_output_dir=os.path.dirname(grayfilename)
createh5file(template_gray_file_transformed,grayfilename,template_gray_file_transformed_mask,grayfilename_mask,output_dir=h5data_output_dir)
    
template_gray_ventricle_file_transformed='/storage1/fs1/dharr/Active/ATUL/PROJECTS/DeepReg/DATA/SAH_1_01052014_2003_2/SAH_1_01052014_2003_2_resaved_levelset_brain_fscct_strippedResampled1_onlyventricle_lin1_1.nii.gz'
template_mask_ventricle_file_transformed_mask='/storage1/fs1/dharr/Active/ATUL/PROJECTS/DeepReg/DATA/SAH_1_01052014_2003_2/SAH_1_01052014_2003_2_resaved_levelset_brain_fscct_strippedResampled1_onlyventricle_lin1_1_BET.nii.gz'

h5data_output_dir=os.path.dirname(grayfilename)
createh5file(template_gray_ventricle_file_transformed,grayfilename,template_mask_ventricle_file_transformed_mask,grayfilename_mask,output_dir=h5data_output_dir)
# # In[18]:
...
# # ## import gray 0
# # image0_file='/storage1/fs1/dharr/Active/ATUL/PROJECTS/SAH/SOFTWARE/REGISTRATION_APPROACH/scct_strippedResampled1.nii.gz'
# # gray2binary(image0_file)
# # image1_file='/storage1/fs1/dharr/Active/ATUL/PROJECTS/NWU/DATA/LVO/output_directoryAugust192021/OUTPUT_42_82/LINEAR_REGISTRATION_OUTPUT/BJH_025_08312019_1743_Head_Spiral_3.0_J40s_2_2_levelset_brain_fscct_strippedResampled1lin1.nii.gz'
